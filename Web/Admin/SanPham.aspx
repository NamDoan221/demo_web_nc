...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width: 100%" class="container">
        ...
        <asp:DataList ID="dtlSanpham" runat="server"  RepeatColumns="3" Width="100%" CellPadding="0">
        <ItemTemplate>
            <asp:Panel ID="Panel1" runat="server"
                style="margin:10px;width:260px;display:flex;flex-direction:column;justify-content:space-between;align-items:center;box-shadow: 0 0.1rem 0.2rem 0 rgba(0, 0, 0, 0.2);border-radius:6px"
                ...
                <div class="mb-3 p-2">
                    <asp:Label CssClass="d-flex text-truncate text-center" style="font-size:16px;font-weight:700;width:250px" ID="Label3" runat="server" Text='<%# Eval("TenSanPham") %>'></asp:Label>
